...
const Navbar = () => {
    return (
        <nav className=" fixed top-0 left-0 w-full z-50 bg-white dark:bg-gray-800 shadow-md rounded-b-lg p-4">
            <div className="container px-32 m-auto  flex justify-between items-center h-12">
                <Link
                    href={"/"}
                    className="text-2xl font-extrabold tracking-tighter text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                    Zachary.dev
                </Link>
